...
from engine.azure.storage.blob._shared import sign_string, url_quote
from engine.azure.storage.blob._shared.constants import X_MS_VERSION
from engine.azure.storage.blob._shared.models import Services
from engine.azure.storage.blob._shared.shared_access_signature import SharedAccessSignature, _SharedAccessHelper, \
    QueryStringConstants

if TYPE_CHECKING:
    from datetime import datetime
    from engine.azure.storage.blob import (
        ResourceTypes,
